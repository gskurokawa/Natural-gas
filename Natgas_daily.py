...
#%% Add gas storage data to data file
...
#%% ECMWF CDDs and HDDs through Open Meteo
...
daily_meteo = pd.read_csv('cdd_hdd_open_daily_monthly.csv')
...
#%% EU+UK power generation mix (no price)
