...
#%% Load ALSI LNG sendout data (EU + UK)
...
#%% Load Entsog gas pipeline entries (EU + UK)
...
if all_monthly_dfs:
    ...
    output_filename = (
        f"europe_pipeline_exports_detailed_{year}.csv"
    )
